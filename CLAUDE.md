...
service/
  ...
  web/{index.html,css/app.css,js/app.js,favicon.svg,favicon.ico,Dockerfile}  # 自建前端(照搬 tz.huilang.me 配色 + monitor.seaya.link 系统字体栈), build 进 nginx 镜像
