...
service/
  ...
  web/{index.html,css/app.css,js/app.js,favicon.svg,fonts/*.woff2,Dockerfile}  # 自建前端(self-host JetBrains Mono), build 进 nginx 镜像
